    ...
    >
          ...
          >
            ...
            <div style={{ padding: "10px 12px 12px" }}>
              ...
              <div style={{ display: "flex", alignItems: "baseline", gap: 4, marginBottom: 6 }}>
                <span style={{ fontSize: 22, fontWeight: 900, color: "#d4608a", lineHeight: 1 }}>
                  {count}
                </span>
                <span style={{ fontSize: 11, fontWeight: 700, color: "#b89ab8" }}>flores</span>
              </div>
      ...
      {ranked.length === 0 && (
        <div style={{ gridColumn: "1 / -1", padding: "80px 0", textAlign: "center" }}>
          ...
          <p style={{ marginTop: 16, fontWeight: 700, color: "#b89ab8" }}>
